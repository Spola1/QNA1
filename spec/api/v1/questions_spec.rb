...
describe 'Questions API', type: :request do
  ...
  describe 'POST /api/v1/questions' do
    ...
    context 'authorized' do
      ...
      context 'with valid attributes' do
        ...
        before { post api_path, params: { question: {title: 'new title', body: 'new body'}, access_token: access_token.token}, headers: headers}
      ...
      context 'with invalid attributes' do
        ...
        before { post api_path, params: { question: attributes_for(:question, :invalid), access_token: access_token.token}, headers: headers}
  ...
  describe 'PATCH /api/v1/questions/:id' do
    ...
    context 'authorized author' do
      ...
      context 'with valid attributes' do
        before { patch api_path, params: {question: {title: 'edited title', body: 'edited body'}, access_token: access_token.token}, headers: headers}
      ...
      context 'with invalid attributes' do
        ...
        before { patch api_path, params: {question: attributes_for(:question, :invalid), access_token: access_token.token}, headers: headers}
      ...
      context 'authorized not author' do
        ...
        before { patch another_api_path, params: {question: {title: 'edited title', body: 'edited body'}, access_token: access_token.token}, headers: headers}
